...
def _fake_runtime() -> dict:
    ...
    return {
        ...
        "generate_daily_plans": lambda portfolio_id, cached_regime=None, config=None: {"buy_plans": [{"id": 1, "ticker": "WOLF"}], "exit_plans": [{"id": 2, "ticker": "NVDA"}], "created_count": 2, "generated_at": "2026-03-26T12:00:00+00:00"},
